<div class="rightbar">
    <div class="rightbar-element rightbar-socials">
        {{-- <div class="rightbar-element-title">
        <h4>@lang('front/rightbar.socials')</h4>
    </div> --}}
        <div class="rightbar-element-container rightbar-socials-container">
            @if (trans('front/information.facebook' != null))
                <div class="rightbar-element-icon">
